...
<h3>從上圖中，我們可以看出：
  <ul>
    <li>北部的藝術工作者占此問卷的多數，第二是南部，其次是中部</li>
    <li>大多數不分地區的藝術工作者都認同心目中藝術跟環境保護十分相關</li>
  </ul>
</h3>`
)}
...
d3
  .scaleOrdinal()
  .domain(["北部", "中部", "東部", "國外", "南部", "1", "2", "3", "4", "5"])
  //.range(d3.schemePaired)
  .range(["#FFBB77","#FFE153","#E8FFC4","#D8D8EB","#B3D9D9","#81C7D4","#CECEFF","#C4E1FF","#FFD0FF","#FFD2D2"])
  .unknown("#BEBEBE")
)}
