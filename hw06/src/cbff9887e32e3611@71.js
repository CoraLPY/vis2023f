...
Plot.plot({
  ...
  color: {
    ...
    range: ['#9491EC', '#e9ec91'],  // 你可以根據需要更改顏色
    legend: true
  },
  marks: [
...
md`<h3>Medium baseline-用SVG完成堆疊柱狀圖</h3>`
)}
...
md`<h3>Medium baseline-在SVG產生的堆疊柱狀圖中加入D3的過渡效果 </h3>`
)}
